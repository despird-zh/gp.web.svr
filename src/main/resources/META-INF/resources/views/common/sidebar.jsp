...
%>
          <ul class="sidebar-menu">		  
			...
			<li class="<%= "dashboard".equals(curr_page) ? "active" : "" %>">
				<a href="dashboard"><i class="fa fa-area-chart"></i> <span>运行状态</span>
				</a>
			</li>
			<li class="<%= "basic".equals(curr_page) ? "active" : "" %>">
				<a href="basic"><i class="fa fa-television "></i> <span>基本信息</span>
				</a>
			</li>
		  	<li class="header">系统配置</li>
			<li class="<%= "sys-option".equals(curr_page) ? "active" : "" %>">
				<a href="sys-option"><i class="fa fa-gear"></i> <span>系统参数</span>
				</a>
			</li>
            <li class="treeview <%= "storage".equals(curr_module) ? "active" : "" %>">
              ...
              <ul class="treeview-menu">
                <li class="<%= "list".equals(curr_page) ? "active" : "" %>">
					<a href="storage-list"><i class="fa fa-circle-o"></i>存储查询</a>
				</li>
                <li class="<%= "new".equals(curr_page) ? "active" : "" %>">
					<a href="storage-new"><i class="fa fa-circle-o"></i>新建存储</a>
				</li>
              </ul>
            </li>
            <li class="treeview <%= "security".equals(curr_module) ? "active" : "" %>">
              ...
              <ul class="treeview-menu">
                <li class="<%= "list".equals(curr_page) ? "active" : "" %>">
					<a href="account-list"><i class="fa fa-circle-o"></i>用户查询</a>
				</li>
                <li class="<%= "new".equals(curr_page) ? "active" : "" %>">
					<a href="account-new"><i class="fa fa-circle-o"></i>新建用户</a>
				</li>
                <li class="<%= "ext".equals(curr_page) ? "active" : "" %>">
					<a href="account-ext"><i class="fa fa-circle-o"></i>外部用户</a>
				</li>
                <li class="<%= "account-sync".equals(curr_page) ? "active" : "" %>">
					<a href="account-sync"><i class="fa fa-circle-o"></i>账户同步</a>
				</li>
              </ul>
            </li>
            <li class="treeview <%= "workgroup".equals(curr_module) ? "active" : "" %>">
              ...
              <ul class="treeview-menu">
                <li class="<%= "list".equals(curr_page) ? "active" : "" %>">
					<a href="workgroup-list"><i class="fa fa-circle-o"></i>工作组查询</a>
				</li>
                <li class="<%= "new".equals(curr_page) ? "active" : "" %>">
					<a href="workgroup-new"><i class="fa fa-circle-o"></i>新建工作组</a>
				</li>
              </ul>
            </li>
			<li class="<%= "orghier".equals(curr_page) ? "active" : "" %>">
				<a href="orghier"><i class="fa fa-tags"></i> <span>组织设置</span>
				</a>
			</li>
            ...
            <li class="treeview <%= "master".equals(curr_module) ? "active" : "" %>">
              ...
              <ul class="treeview-menu">
                <li class="<%= "images".equals(curr_page) ? "active" : "" %>">
					<a href="image-list"><i class="fa fa-circle-o"></i>图片查询</a>
				</li>
                <li class="<%= "dictionary".equals(curr_page) ? "active" : "" %>">
					<a href="dict-list"><i class="fa fa-circle-o"></i>字典查询</a>
				</li>
              </ul>
            </li>
